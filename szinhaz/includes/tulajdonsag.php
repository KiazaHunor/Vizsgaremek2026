...
if(isset($_POST))
{
  ...
  elseif($postNew==""){
    adatInsert($postNev,$postEmail,$postTelefon,$postTelepules,$postTelepulesId);
  }
...
';
  ...
  function adatInsert($nev,$email,$telefon,$telepules_id){
    GLOBAL $conn; 
  ...
  function adatUpdate($id,$nev,$email,$telefon,$telepules_id){
    GLOBAL $conn; 
